...
## 4. Visual Diagnostics Gallery
Below are the empirical visualization artifacts generated by our data-first profiling pipeline before any training loops were initialized:

### Batch Sanity Check
Reversing normalization and tensor dimensions ensures our transformation pipeline keeps images fully intact without distorting target features.
![Batch Visualization](images/batch_visualization.png)

### Attribute Frequency Matrix
Visually isolating the absolute frequencies reveals severe class sparse categories, dictating the immediate need for a weighted loss strategy.
![Attribute Frequency](images/attribute_frequency.png)
